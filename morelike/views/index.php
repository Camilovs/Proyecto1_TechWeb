...
<script type="text/javascript">
	...
	function nuevoProcedimiento() {
		$.post(base_url + "Principal/nuevoProcedimiento", {}, function(html, data) {
	...
	function nuevaArea() {
		$.post(base_url + "Principal/newArea", {}, function(html, data) {
			$("#contenedor").html(html, data);
			$("#contenedor").show("fast");
		});
	}
	...
	function nuevoUser() {
		$.post(base_url + "Principal/newUser", {}, function(html, data) {
			$("#contenedor").html(html, data);
			$("#contenedor").show("fast");
		});
	}
	...
	function nuevoLink() {
		$.post(base_url + "Principal/newLink", {}, function(html, data) {
			$("#contenedor").html(html, data);
			$("#contenedor").show("fast");
		});
	}
	...
	function validaClave0() {
		if ($("#claveVieja").val() != "") {
			$.post(base_url + "Principal/validaClave0", {
	...
	function cambiarClave() {
		$.post(base_url + "Principal/cambiarClave", {
			clave: $("#claveNueva2").val()
		}, function() {
			$("#exampleModal").hide();
